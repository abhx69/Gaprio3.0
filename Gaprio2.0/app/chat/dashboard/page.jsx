    ...
    socket.current.on('new message', (message) => {
      ...
      if (
        ...
        (message.is_ai_response && (
          ...
          // When viewing AI chat directly, show all AI responses to you
          (selectedUser?.id === AI_USER_ID && message.receiver_id === user.id)
        ))
      ) {
        console.log('Displaying message:', message);
        setMessages((prevMessages) => [...prevMessages, message]);
      } else {
        console.log('Filtered out message:', message, 'Selected user:', selectedUser?.id);
      }
    });
